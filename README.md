...
NIST CCVS85 の<b>受理率</b>は 95.9% (458 本中 439 本、壊れたもの 0 本) である。
<b>動かした合格率</b>は 87.3% (361 本中 315 本) であり、検査ごとに数えると 99.4%
(8619 件流れて 56 件落ちた) である。<b>壊れる本も返ってこない本も 0 になった</b>。受理率は「翻訳が通るか」、合格率は
「規格どおりに動くか」であり、後者が要件 NFR-040 の言う数である。
このうち 127 件は検査スイート自身が「人が紙を見て決めろ」と言っている検査であり、
<b>道具は確かめていない</b>。14 本がそれを抱えたまま「通った」に入っているので、
その分だけ合格率は甘い。
落ちた 56 件のうち<b>25 件は `ACCEPT`</b> であり、卓の人が値を打ち込むことを求めている
検査である。道具に人はいないので通らない。前の測定まではこの 2 本 (NC109M、NC204M) が
途中で壊れており、25 件は<b>数にすら出ていなかった</b>。
配布物の検査プログラムは<b>全数を流している</b> (札が足りずに流せないものは無い)。
テスト 1778 件 (この環境で流れた数)。
