...
<b>動かした合格率</b>は 92.5% (361 本中 334 本) であり、検査ごとに数えると 99.8%
(8709 件流れて 16 件落ちた) である。<b>壊れる本も返ってこない本も 0 である</b>。
受理率は「翻訳が通るか」、合格率は
「規格どおりに動くか」であり、後者が要件 NFR-040 の言う数である。
このうち 127 件は検査スイート自身が「人が紙を見て決めろ」と言っている検査であり、
<b>道具は確かめていない</b>。15 本がそれを抱えたまま「通った」に入っているので、
その分だけ合格率は甘い。
