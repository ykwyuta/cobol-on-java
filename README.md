...
- [IBM i (AS/400) 資産のコンパイルおよび実行方式検討](docs/research/ibm-i-support-and-execution-requirements.md) — RPG / DDS / Db2 for i / CL / 5250 が既存ランタイムに載る範囲、Hercules に相当する外の基準が無いこと、H2 を拡張しない理由
