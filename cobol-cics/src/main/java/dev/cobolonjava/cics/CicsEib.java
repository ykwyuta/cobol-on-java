...
public final class CicsEib {
    ...
    private static final java.util.Map<Integer, java.util.Set<Integer>> ZERO_RCODE_GROUPS = java.util.Map.ofEntries(
            ...
            java.util.Map.entry(CicsResponseCode.INVREQ, java.util.Set.of(0x0600, 0x0800, 0x0A00, 0x1000, 0x3400)),
            ...
            java.util.Map.entry(CicsResponseCode.IOERR, java.util.Set.of(0x0600, 0x0800, 0x1000)),
            java.util.Map.entry(CicsResponseCode.NOSPACE, java.util.Set.of(0x0600, 0x0800)),
            java.util.Map.entry(CicsResponseCode.NOTOPEN, java.util.Set.of(0x0800)),
